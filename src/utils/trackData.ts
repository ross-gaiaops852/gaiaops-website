...
export const tracks: Track[] = [
  {
    ...
    description:
      'Three proven playbooks that eliminate project delays, communication breakdowns, and partner frustration through systematic coordination transformation.',
    color: '#4A9B8B', // Teal Primary
    foundationLevel:
      'Foundation playbook: Airtable dashboard, basic integrations',
    ...
    idealState:
      'Seamless partner collaboration with zero coordination meetings',
    href: '/services/multi-party-coordination',
    foundationDetails: {
      hours: '40 hours',
      weeks: '6 weeks',
      description:
        'Foundation playbook delivering Airtable-based central project dashboard with basic partner integrations',
      features: [
      ...
      impact:
        '40% reduction in coordination meetings, clear project visibility',
    },
    advancedDetails: {
      hours: '50 hours',
      weeks: '7 weeks',
      description:
        'Advanced playbook delivering n8n automation for real-time data sync across 5+ systems',
      features: [
    ...
    completeDetails: {
      ...
      weeks: '8 weeks',
      description:
        'Complete playbook delivering RAG-enabled AI Oracle with predictive analytics and unlimited partner coordination',
      features: [
  ...
  },
  {
    ...
    description:
      'Three proven playbooks that transform client relationships through automated onboarding, proactive success management, and expansion optimization.',
    color: '#1E3A5F', // Navy Primary
    foundationLevel: 'Foundation playbook: Automated intake, client portal',
    advancedLevel:
      'Advanced playbook: Health scoring, automated communications',
    completeLevel:
      'Complete playbook: AI client analysis, expansion identification',
    idealState:
      'Self-managing client relationships with proactive success optimization',
    href: '/services/client-relationships',
    foundationDetails: {
      hours: '40 hours',
      weeks: '6 weeks',
      description:
        'Foundation playbook delivering automated intake, basic client portal, standardized kickoff processes',
      features: [
    ...
    advancedDetails: {
      ...
      weeks: '7 weeks',
      description:
        'Advanced playbook delivering predictive client health scoring, automated milestone communications',
      features: [
      ...
      impact:
        '25% improvement in client retention, proactive relationship management',
    },
    completeDetails: {
      hours: '55 hours',
      weeks: '8 weeks',
      description:
        'Complete playbook delivering AI-powered client analysis, automatic expansion identification',
      features: [
      ...
      impact:
        '40% increase in client lifetime value, strategic partnership development',
    },
  },
  {
    ...
    description:
      'Three proven playbooks that maximize team utilization, optimize project profitability, and enable strategic capacity expansion through systematic resource management.',
    color: '#E07A47', // Orange Accent
    foundationLevel:
      'Foundation playbook: Capacity dashboards, project templates',
    advancedLevel: 'Advanced playbook: Real-time optimization, skills matching',
    completeLevel:
      'Complete playbook: AI demand forecasting, automated sourcing',
    idealState:
      'Perfect resource utilization with predictive capacity planning',
    href: '/services/resource-optimization',
    foundationDetails: {
      hours: '45 hours',
      weeks: '6 weeks',
      description:
        'Foundation playbook delivering capacity planning dashboards, project templates, budget tracking',
      features: [
      ...
      impact:
        '30% improvement in team utilization, better project profitability',
    },
    advancedDetails: {
      hours: '50 hours',
      weeks: '7 weeks',
      description:
        'Advanced playbook delivering real-time optimization algorithms, skills-based matching',
      features: [
      ...
      impact:
        '50% improvement in utilization rates, strategic capacity expansion',
    },
    completeDetails: {
      hours: '60 hours',
      weeks: '8 weeks',
      description:
        'Complete playbook delivering AI-powered demand forecasting, automated contractor sourcing',
      features: [
  ...
  },
  {
    ...
    description:
      'Three proven playbooks that ensure consistent deliverable quality, automate compliance management, and eliminate quality surprises through systematic QA processes.',
    ...
    completeLevel:
      'Complete playbook: AI quality prediction, improvement systems',
    ...
    foundationDetails: {
      ...
      weeks: '6 weeks',
      description:
        'Foundation playbook delivering document version control, quality checklists, compliance tracking',
      features: [
    ...
    advancedDetails: {
      ...
      weeks: '7 weeks',
      description:
        'Advanced playbook delivering automated quality scoring, risk assessment workflows',
      features: [
    ...
    completeDetails: {
      ...
      weeks: '8 weeks',
      description:
        'Complete playbook delivering AI-powered quality risk prediction, continuous improvement recommendations',
      features: [
  ...
  },
  {
    ...
    description:
      'Three proven playbooks that transform data into strategic insights through automated reporting, real-time dashboards, and predictive analytics.',
    ...
    idealState:
      'Automatic business intelligence with predictive strategic guidance',
    href: '/services/business-intelligence',
    foundationDetails: {
      hours: '45 hours',
      weeks: '6 weeks',
      description:
        'Foundation playbook delivering template-driven reports, client dashboards, basic data aggregation',
      features: [
    ...
    advancedDetails: {
      ...
      weeks: '7 weeks',
      description:
        'Advanced playbook delivering real-time performance dashboards, automated KPI tracking',
      features: [
    ...
    completeDetails: {
      ...
      weeks: '8 weeks',
      description:
        'Complete playbook delivering AI-powered business insights, predictive modeling, strategic recommendations',
      features: [
      ...
      impact:
        'Predictive business intelligence, strategic competitive advantage',
    },
  },
  {
    id: 'growth-systems',
    ...
    description:
      'Three proven playbooks that build systematic growth capabilities through optimized lead management, automated business development, and strategic expansion systems.',
    color: '#4A9B8B', // Teal Primary
    ...
    completeLevel:
      'Complete playbook: Predictive conversion, automated positioning',
    ...
    foundationDetails: {
      ...
      weeks: '6 weeks',
      description:
        'Foundation playbook delivering lead tracking workflows, proposal templates, basic CRM',
      features: [
    ...
    advancedDetails: {
      ...
      weeks: '7 weeks',
      description:
        'Advanced playbook delivering advanced lead scoring, competitive intelligence tools',
      features: [
    ...
    completeDetails: {
      ...
      weeks: '8 weeks',
      description:
        'Complete playbook delivering predictive conversion optimization, automated competitive positioning',
      features: [
  ...
  },
  {
    ...
    description:
      'Three proven playbooks that create sustainable competitive advantage through operational differentiation, strategic positioning, and market leadership capabilities.',
    color: '#1E3A5F', // Navy Primary (Premium)
    foundationLevel: 'Foundation playbook: Market analysis, value assessment',
    advancedLevel:
      'Advanced playbook: Unique positioning, competitive strategy',
    completeLevel:
      'Complete playbook: Chief Problem Officer, predictive analysis',
    ...
    foundationDetails: {
      ...
      weeks: '7 weeks',
      description:
        'Foundation playbook delivering market position analysis, value chain assessment, strategic problem identification',
      features: [
      ...
      impact:
        'Clear strategic positioning, competitive differentiation foundation',
    },
    advancedDetails: {
      hours: '55 hours',
      weeks: '8 weeks',
      description:
        'Advanced playbook delivering unique value proposition development, competitive differentiation strategy',
      features: [
    ...
    completeDetails: {
      ...
      weeks: '8 weeks',
      description:
        'Complete playbook delivering Chief Problem Officer methodology, predictive market analysis, bespoke advantage creation',
      features: [
      ...
      impact:
        'Market leadership capabilities, predictive competitive advantage',
    },
  },
];
...
export function getTracksByCategory(
  category: 'foundation' | 'optimization' | 'excellence'
): Track[] {
  switch (category) {
    case 'foundation':
